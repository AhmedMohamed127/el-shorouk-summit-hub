...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "الملتقى العلمي لنظم معلومات الأعمال — أكاديمية الشروق" },
      ...
      { name: "twitter:title", content: "الملتقى العلمي لنظم معلومات الأعمال — أكاديمية الشروق" },
